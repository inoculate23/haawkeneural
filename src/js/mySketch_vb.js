...
let font = './Fhwaseriesbc2021plus10-qZO8V.otf./Lment-v02.otf';
//auto change
let changeDuration = 3000;
let lastChange = 0;
function preload() {
	fontRegular = loadFont('./Fhwaseriesbc2021plus10-qZO8V.otf');
}
function setup() {
...
function draw() {
	...
	*/
	...
	if(length == 0){
		...
		textSize(30);
		text("Click to release particles", centerX, 650);
		return;
	}
